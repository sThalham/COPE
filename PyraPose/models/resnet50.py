...
def resnet_model(num_classes, obj_diameters, correspondences=None, inputs=None, modifier=None, **kwargs):
    ...
    return model.pyrapose(inputs=inputs, num_classes=num_classes, obj_correspondeces=correspondences, obj_diameters=obj_diameters, backbone_layers=resnet_outputs, **kwargs)
