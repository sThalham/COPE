...
def assert_training_model(model):
    ...
    assert (all(output in model.output_names for output in ['points', 'boxes', 'cls'])), "Input is not a training model. Outputs were found, outputs are: {}).".format(model.output_names)
