...
class CustomModel(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        return {"loss": self.loss_tracker.result(), "points": self.points_tracker.result(), "cls": self.cls_tracker.result(), "translations": self.translations_tracker.result(), "rotations": self.rotations_tracker.result(), "reprojection": self.consistency_tracker.result(),}
    ...
    def metrics(self):
        ...
        return [self.loss_tracker, self.points_tracker, self.cls_tracker, self.translations_tracker, self.rotations_tracker, self.consistency_tracker]
